                    ...
                    <div>
                        <form action="{{ route("alternatif.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="nik" class="input input-bordered w-full text-primary-color" value="{{ old("nik") }}" maxlength="16" pattern="[0-9]{16}" oninput="validateNIK(this)" required />
                                @error("nik")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                ...
                <div class="modal-box">
                    ...
                    <div>
                        <label class="form-control w-full">
                            ...
                            <input type="text" name="show_kode" class="input input-bordered w-full text-primary-color" readonly />
                        </label>
                        ...
                        <label class="form-control w-full">
                            ...
                            <input type="text" name="show_nik" class="input input-bordered w-full text-primary-color" readonly />
                        </label>
                        ...
                        <label class="form-control w-full">
                            ...
                            <input type="text" name="show_alternatif" class="input input-bordered w-full text-primary-color" readonly />
                        </label>
                        ...
                        <label class="form-control w-full">
                            ...
                            <textarea class="textarea textarea-bordered w-full text-primary-color" name="show_keterangan" readonly></textarea>
                        </label>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <form action="{{ route("alternatif.update") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="nik" class="input input-bordered w-full text-primary-color" maxlength="16" pattern="[0-9]{16}" oninput="validateNIK(this)" required />
                                @error("nik")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                    ...
                    <div>
                        <form action="{{ route("alternatif.import") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <div class="label">
                                    <span class="label-text-alt text-xs text-gray-500">Format: kode, nik, alternatif, keterangan</span>
                                </div>
                                @error("import_data")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                            ...
                            <tbody>
                                @foreach ($alternatif as $item)
                                    <tr class="border-b border-primary-color bg-transparent dark:border-primary-color-dark">
                                        ...
                                        <td class="w-32">
                                            <p class="text-center align-middle text-sm font-medium leading-tight text-primary-color dark:text-primary-color-dark break-all">
                                                {{ $item->nik }}
                                            </p>
                                        </td>
                                        <td class="w-auto min-w-0">
                                            <p class="text-left align-middle text-base font-semibold leading-tight text-primary-color dark:text-primary-color-dark px-2">
                                                {{ $item->alternatif }}
                                            </p>
                                        </td>
                                        <td class="w-32">
