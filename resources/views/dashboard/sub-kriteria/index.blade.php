...
@section("container")
    <div class="-mx-3 flex flex-wrap">
        <div class="w-full max-w-full flex-none px-3">
            ...
            <div class="modal modal-middle fixed inset-0 z-50 flex items-center justify-center" role="dialog"
                style="align-items: flex-start; padding-top: 150px;">
            ...
            <div
                ...
                @foreach ($kriteria as $kri)
                    <div class="mb-5">
                        <div
                            class="border-b-solid mb-0 flex items-center justify-between rounded-t-2xl border-b-0
                            border-b-transparent p-6 pb-3">
                            ...
                            <div class="text-sm text-gray-600">
                                <span class="font-semibold">Total Bobot: 
                                    <span class="text-primary-color">{{ $subKriteria->where('kriteria_id', $kri->id)->sum('bobot') }}%</span>
                                </span>
                                | 
                                <span class="font-semibold">Sisa: 
                                    <span class="text-{{ (100 - $subKriteria->where('kriteria_id', $kri->id)->sum('bobot')) < 0 ? 'red' : 'green' }}-600">
                                        {{ 100 - $subKriteria->where('kriteria_id', $kri->id)->sum('bobot') }}%
                                    </span>
                                </span>
                            </div>
                        </div>
                        <div class="flex-auto px-0 pb-2 pt-0">
                            <div class="overflow-x-auto p-0 px-6 pb-6">
                                <table id="{{ 'myTable_' . $kri->id }}" class="nowrap stripe mb-3 w-full max-w-full border-collapse items-center
                                                align-top" style="width: 100%;">
