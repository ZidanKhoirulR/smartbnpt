                    ...
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                                    ...
                                    <tr class="border-b border-primary-color bg-transparent dark:border-primary-color-dark">
                                        ...
                                        @else
                                            @foreach ($kriteria as $krit)
                                                <td>
                                                    {{-- Tampilkan nilai utility untuk kriteria ini --}}
                                                    @php
                                                        $utilityValue = $nilaiUtility
                                                            ...
                                                            ->first();
                                                    @endphp
                                                    {{ $utilityValue ? number_format($utilityValue->nilai, 4) : '-' }}
                                                </td>
                                            @endforeach
                                        @endif
                                    </tr>
                        ...
                        <div class="w-fit overflow-x-auto">
                            <table class="table table-xs">
                                ...
                                <tr>
                                    <td class="text-base text-primary-color dark:text-primary-color-dark">* Pastikan setiap
                                        alternatif terisi semua pada menu penilaian</td>
